...
public class AgendaApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        TableColumn<Agenda, String> colFecha = new TableColumn<>("Fecha");
        colFecha.setCellValueFactory(new PropertyValueFactory<>("fecha"));

        TableColumn<Agenda, String> colHora = new TableColumn<>("Hora");
        ...
        tabla.getColumns().addAll(Arrays.asList(
                colId, colPaciente, colFecha, colHora, colEstado));
        ...
        cbEstado.getItems().addAll(
                "PROGRAMADA", "CONFIRMADA", "CANCELADA", "FINALIZADA");
        ...
        VBox root = new VBox(15, titulo, formulario, btnCargar, tabla);
        root.setStyle("""
                -fx-padding: 20;
